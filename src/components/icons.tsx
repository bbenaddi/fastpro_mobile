...
export const PowerOutlineIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name='power-outline'/>
);
export const ShoppinCartIcon = (style: ImageStyle): IconElement => (
...
export const BulbOutIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name='bulb-outline'/>
);

export const CreditCardOutlineIcon = (style: ImageStyle): IconElement => (
...
export const PeopleOutLineIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name='people-outline'/>
);

export const ArchiveOutLineIcon = (style: ImageStyle): IconElement => (
  <Icon {...style} name='archive-outline'/>
);

export const VolumeUpOutLineIcone = (style: ImageStyle): IconElement => (
...
export const CarOutLineIcon = (style: ImageStyle): IconElement => (
